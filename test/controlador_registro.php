...
if($resultado==0){
  ...
  echo"<label>El usuario ya existe, vuelva a registrarse con un nombre de usuario diferente<label> </br>";
  ...
  echo"<label>El usuario ha sido creado con exito, vuelve a inicio para iniciar sesión<label></br>";
  echo"<button class='btn btn-primary' value='Volver a inicio' onclick='volver_a_inicio()'>Volver a inicio de sesion</Button>";
}
